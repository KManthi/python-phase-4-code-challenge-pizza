...
class Restaurant(db.Model, SerializerMixin):
    ...
    serialize_rules = ('-restaurant_pizzas.restaurant', '-pizzas.restaurant_pizzas', '-restaurant_pizzas.pizza.restaurants')
...
class Pizza(db.Model, SerializerMixin):
    ...
    serialize_rules = ('-restaurant_pizzas.pizza', '-restaurants.restaurant_pizzas', '-restaurant_pizzas.restaurant.pizzas')
